...
?>
    ...
    <main class="contenedor seccion contenido-centrado">
        ...
        <img src="build/img/destacada2.webp" alt="blog image">
        ...
        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Sit molestias quaerat voluptatibus
            ...
            consectetur adipisicing elit. Eius nisi enim vitae voluptas quidem. Minima non esse molestias sit delectus
            nulla,
            repellendus neque eligendi, laborum fugit nisi dolor numquam alias.
        </p>
        <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Eum accusantium sapiente perspiciatis. Deserunt
            magnam
            inventore quam cupiditate facere, corrupti, praesentium ipsum id repellat porro doloremque totam culpa in
            corporis
            quas.
        </p>
    </main>
